...
namespace Leopotam.EcsLite.PhysicsExtensions
{
    public static class PhysicsWorld
    {
        ...
        public static void Initialize(EcsWorld world)
        {
            ...
            _triggerExitEmitter = new EcsEmitter<TriggerExitEvent>(world);
            _collisionEnterEmitter = new EcsEmitter<CollisionEnterEvent>(world);
            _collisionExitEmitter = new EcsEmitter<CollisionExitEvent>(world);
        }
