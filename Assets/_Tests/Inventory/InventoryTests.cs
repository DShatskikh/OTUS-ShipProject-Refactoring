...
//         {
//             // Arrange:
//             var inventory = new MainInventory();
...
//             inventory.Add(item2);
//             
//             ItemUseCases.TryGetComponent(inventory.Slots[0, 0], out StackableItemComponent stackableItemComponent);
//             
//             // Assert:
...
//             
//             // Assert:
//             Assert.NotNull(inventory.Slots[0, 0]);
//         }
//     }
// }